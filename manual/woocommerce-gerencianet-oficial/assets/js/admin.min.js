...
function showGnTutorial(tutorial) {
  switch(tutorial) {
    case "keysDevelopment": jQuery("#imgTutorial").attr("src", home_url + "wp-content/plugins/woocommerce-gerencianet-oficial/assets/images/gerencianet-exemplo-chaves-desenvolvimento.png"); break;
    case "keysProduction": jQuery("#imgTutorial").attr("src", home_url + "wp-content/plugins/woocommerce-gerencianet-oficial/assets/images/gerencianet-exemplo-chaves-producao.png"); break;
    case "payeeCode": jQuery("#imgTutorial").attr("src", home_url + "wp-content/plugins/woocommerce-gerencianet-oficial/assets/images/gerencianet-exemplo-identificador-conta.png"); break;
  }
