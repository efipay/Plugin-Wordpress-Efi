                        ...
                        <div class="gn-osc-row required">
                            ...
                            <div>
                                ...
                                <div class="gn-col-2">
                                    ...
                                    <script>
                                    document.getElementById('ccicon').innerHTML = other;
                                    </script>
                                ...
                                <div class="gn-col-10" style="margin-left: -1em;">
                                    ...
                                    const inputHandler = function() {
                                        getCardFlag(document.getElementById('gn_card_number_card').value);
                                        // getInstallments(document.getElementById('input-payment-card-brand').value)
                                    }
