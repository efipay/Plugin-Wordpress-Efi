 ...
 * @method array refundCard(array $params, array $body)
 * 
 * API PIX
 ...
 * @method array pixCreateDueChargeBatch(array $params, array $body)
 * @method array pixUpdateDueChargeBatch(array $params, array $body)
 * @method array pixDetailDueChargeBatch(array $params)
 * @method array pixListDueChargeBatch(array $params)
 * @method array pixQrCodeDetail(array $params = [], array $body)
 * @method array pixQrCodePay(array $params, array $body)
 * @method array pixConfigWebhookRecurrenceAutomatic(array $params = [], array $body)
 * @method array pixListWebhookRecurrenceAutomatic()
 * @method array pixDeleteWebhookRecurrenceAutomatic()
 * @method array pixConfigWebhookAutomaticCharge(array $params = [], array $body)
 * @method array pixListWebhookAutomaticCharge()
 * @method array pixDeleteWebhookAutomaticCharge()
 * @method array pixCreateLocationRecurrenceAutomatic()
 * @method array pixListLocationRecurrenceAutomatic($params)
 * @method array pixDetailLocationRecurrenceAutomatic($params)
 * @method array pixUnlinkLocationRecurrenceAutomatic($params)
 * @method array pixDetailRecurrenceAutomatic($params)
 * @method array pixUpdateRecurrenceAutomatic($params, $body)
 * @method array pixListRecurrenceAutomatic($params, $body)
 * @method array pixCreateRecurrenceAutomatic($params = [], $body)
 * @method array pixCreateRequestRecurrenceAutomatic($params = [], $body)
 * @method array pixDetailRequestRecurrenceAutomatic($params)
 * @method array pixUpdateRequestRecurrenceAutomatic($params, $body)
 * @method array pixCreateAutomaticChargeTxid($params, $body)
 * @method array pixUpdateAutomaticCharge($params, $body)
 * @method array pixDetailAutomaticCharge($params)
 * @method array pixCreateAutomaticCharge($params = [], $body)
 * @method array pixListAutomaticCharge($params)
 * @method array pixRetryRequestAutomatic($params)
 * 
 * API OPEN FINANCE
